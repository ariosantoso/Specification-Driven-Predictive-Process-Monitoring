 ...
 */
public class FormulaEXISTS extends FormulaQuantified{

    
    public FormulaEXISTS(String variable, Formula formula){
        super(variable, formula);
    }

	public String toString(){
        return
            "EXISTS "+getQuantifiedVariable().toString() +"." +
                "( "+
	...
	public String prettyFormat(String tab) {
        return
                tab+"EXISTS "+getQuantifiedVariable().toString() +".\n" +
//                tab+"(\n"+
...
//                tab+")"+ 
	...
	public FormulaEXISTS clone(){
		return new FormulaEXISTS(new String(this.getQuantifiedVariable()), this.getComponent().clone());
	}
...
//		System.out.println("====================================================================================");
		...
		Formula prev = new FormulaOR(newFormula[0], newFormula[1]);
		Formula result = new FormulaOR(newFormula[0], newFormula[1]);
		
		for(int ii = 2; ii < newFormula.length; ii++){
			
			result = new FormulaOR(prev, newFormula[ii]);
			prev = result;
		}
