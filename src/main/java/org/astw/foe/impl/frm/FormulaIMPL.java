 ...
 */
public class FormulaIMPL extends FormulaBinary{


    public FormulaIMPL(Formula formula1, Formula formula2){
        super(formula1, BinaryLogicalOperator.IMPL, formula2);
    }

	@Override
	public Formula clone() {
		return new FormulaIMPL(this.getComponent1().clone(), this.getComponent2().clone());
	}

	@Override
	public Formula eliminateQuantifier(int domainSize) {
		return new FormulaIMPL(	this.getComponent1().eliminateQuantifier(domainSize), 
