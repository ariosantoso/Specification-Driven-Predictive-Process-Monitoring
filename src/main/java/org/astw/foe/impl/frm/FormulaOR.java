...
public class FormulaOR extends FormulaBinary{
    ...
    public FormulaOR(Formula formula1, Formula formula2){
        super(formula1, BinaryLogicalOperator.OR, formula2);
    }

	@Override
	public Formula clone() {
		return new FormulaOR(this.getComponent1().clone(), this.getComponent2().clone());
	}

	@Override
	public Formula eliminateQuantifier(int domainSize) {
		return new FormulaOR(	this.getComponent1().eliminateQuantifier(domainSize), 
