...
@Plugin(name = "Prediction Service Provider - Version P", 
 ...
 */
public class PluginPredictionServicePy {

	private final String pluginName = "SDPROM (Prediction Service Provider - Version P)";
    ...
    @PluginVariant(variantLabel = "Prediction Service Provider - Version P", requiredParameterLabels = {0})
