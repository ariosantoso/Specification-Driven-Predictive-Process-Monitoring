...
public class TraceViewerPanel extends JPanel{

	private AnalyticRuleSpec ars;

	public void setTrace(XTrace xtrace){
		...
		for(XEvent xevent : xtrace){
			...
			cteps.add(new JScrollPane(new EventViewerPanel(xevent,idx++ )));
...
//	public void setTrace(XTrace xtrace){
//
//			ArrayList<EventViewerPanel> cteps = new ArrayList<EventViewerPanel>();
//			
//			int idx = 1;
//			for(XEvent xevent : xtrace){
//				
//				cteps.add(new EventViewerPanel(xevent,idx++ ));
//				cteps.get(cteps.size()-1).setBorder(javax.swing.BorderFactory.createLineBorder(Color.LIGHT_GRAY));
//			}
//						
//			javax.swing.GroupLayout layout = new javax.swing.GroupLayout(this);
