...
public class ModelConfigFrame2 extends JFrame {
	...
	private final String NO_SPECIAL_FORMAT = "No special format";
	private final String TO_TIMESTAMP_STRING = "Convert to timestamp string (e.g., yy:mm:dd - hh:mm:ss)";
...
//        int panelHeight = ((int)oneHotEncCheckBox.getPreferredSize().getHeight()) * 2 * attributes.size() + 170;
        ...
        // set panel for selecting outputformat
        
        outputFormatPanel.setBorder(BorderFactory.createTitledBorder(" Output Special Format"));
        outputFormatPanel.setToolTipText("");

        outputFormatLabel.setHorizontalAlignment(SwingConstants.RIGHT);
        outputFormatLabel.setLabelFor(outputFormatComboBox);
        
    	outputFormatLabel.setText("options:");
    	outputFormatComboBox.setModel(new DefaultComboBoxModel<String>(outputFormatOption));
        ...
        GroupLayout outputFormatPanelLayout = new GroupLayout(outputFormatPanel);
        outputFormatPanel.setLayout(outputFormatPanelLayout);
        outputFormatPanelLayout.setHorizontalGroup(
        	outputFormatPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(outputFormatPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(outputFormatLabel, GroupLayout.PREFERRED_SIZE, 121, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(outputFormatComboBox, GroupLayout.PREFERRED_SIZE, 371, GroupLayout.PREFERRED_SIZE)
                .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        outputFormatPanelLayout.setVerticalGroup(
        		outputFormatPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(GroupLayout.Alignment.TRAILING, outputFormatPanelLayout.createSequentialGroup()
                .addGap(4, 4, 4)
                .addGroup(outputFormatPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(outputFormatLabel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(outputFormatComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        
        
        
        //The whole panel layout
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(outputFormatPanel, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(outputFormatPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void saveButtonActionPerformed(ActionEvent evt) {
    	...
    	if (selectedOutputFormat.equals(TO_TIMESTAMP_STRING))
    		specialOutputFormat = SpecialOutputFormat.TIMESTAMP_STRING;
    	else if (selectedOutputFormat.equals(CONVERT_TO_HOURS))
    		specialOutputFormat = SpecialOutputFormat.HOURS;
    	else 
